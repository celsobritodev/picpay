...
INSERT INTO `tb_tansfer` VALUES (_binary '\r5éµã†Dyô≥\È\∆8öN',0.00,2,1),(_binary '\"≥\“\Ê\n3B\Óò\Á%\«T≤j',20.00,3,1),(_binary '/¢õ\ÎêJA¶\‡0∞x\Ó\·˙',5.00,2,1),(_binary '7Ça\Êñ\Ô@Hπ1]êö˜\Ì',5.00,2,1),(_binary 'NåT1\⁄GÑµº\‰hM)',0.00,2,1),(_binary 'Sm9cXKu≠ı\€fªYÅ`',5.00,2,1),(_binary 'W4ä:\…HıçÅ\n\Îè',5.00,2,1),(_binary 'Z™Cå±I¡™\„\›KUì\0',0.00,2,1),(_binary 'g\–t \‚Dd®D}¥ìY\◊I',0.00,2,1),(_binary 'äsHı&K¥•;b\‚ûoI',0.00,2,1),(_binary 'îTM-FMÀ¢\…ı\\°˝\»',5.00,2,1),(_binary '≤(<ÇM\…CÜ∂y˛s£à',5.00,2,1),(_binary '¸\n£hÚI\Èî\Z˘T∫\Õ',20.00,3,1);
